...
export default function DashboardPage() {
  return (
    <div className="bg-white">
      <div className="mx-auto max-w-7xl py-16 px-6 sm:py-32 lg:grid lg:grid-cols-3 lg:gap-x-12 lg:px-8 lg:py-24">
        <div>
          <h2 className="text-lg font-semibold leading-8 tracking-tight text-eden-600">
            Everything you need
          </h2>
          ...
          <dl className="grid grid-cols-1 gap-12 sm:grid-flow-col sm:grid-cols-2 sm:grid-rows-4">
            {features.map((feature) => (
              <div key={feature.name} className="relative">
                <dt>
                  <CheckIcon
                    className="absolute mt-1 h-6 w-6 text-eden-600"
                    aria-hidden="true"
                  />
